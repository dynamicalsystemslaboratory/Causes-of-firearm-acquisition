...
MS=sum(Mshooting_Patterns_states,2)>0;% binary time-series mass shootings at a national leval
MS(177)=1;% we include  DC 2013-09
...
%Calculate the p-value for significance of transfer entropy for restrictive
 ...
 %gather all results
 resultsStu1=[me_TEMStoBCrcondMOfc_MOs me_TEMStoBCpcondMOfc_MOs me_TEMOfctoBCrcondMS_MOs...
